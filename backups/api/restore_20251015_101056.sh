...
#     -d @profiles_20251015_101056.json \
...
#     -H "Authorization: Bearer $VITE_SUPABASE_PUBLISHABLE_KEY" \
#     -H "Content-Type: application/json" \
#     -d @workshops_20251015_101056.json \
...
#     -H "Authorization: Bearer $VITE_SUPABASE_PUBLISHABLE_KEY" \
#     -H "Content-Type: application/json" \
#     -d @analysis_20251015_101056.json \
...
#     -H "Authorization: Bearer $VITE_SUPABASE_PUBLISHABLE_KEY" \
#     -H "Content-Type: application/json" \
#     -d @vehicle_data_20251015_101056.json \
...
#     -H "Authorization: Bearer $VITE_SUPABASE_PUBLISHABLE_KEY" \
#     -H "Content-Type: application/json" \
#     -d @insurance_amounts_20251015_101056.json \
...
#     -H "Authorization: Bearer $VITE_SUPABASE_PUBLISHABLE_KEY" \
#     -H "Content-Type: application/json" \
#     -d @workshop_costs_20251015_101056.json \
